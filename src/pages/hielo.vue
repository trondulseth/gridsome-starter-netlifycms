<template>
	<div>
		...
		<section class="banner full">
			<article>
				<img src="images/hielo/slide01.jpg" alt="" />
				<div class="inner">
					<header>
						<p>
			...
			<article>
				<img src="images/hielo/slide02.jpg" alt="" />
				<div class="inner">
					<header>
			...
			<article>
				<img src="images/hielo/slide03.jpg" alt="" />
				<div class="inner">
					<header>
			...
			<article>
				<img src="images/hielo/slide04.jpg" alt="" />
				<div class="inner">
					<header>
						<p>
							Adipiscing lorem ipsum feugiat sed phasellus
							consequat
						</p>
						<h2>Etiam feugiat</h2>
					</header>
			...
			<article>
				<img src="images/hielo/slide05.jpg" alt="" />
				<div class="inner">
					<header>
			...
			<div class="inner">
				<div class="grid-style">
					<div>
						<div class="box">
							<div class="image fit">
								<img src="images/hielo/pic02.jpg" alt="" />
							</div>
							<div class="content">
								...
								<p>
									...
									malesuada elit facilisis. Vestibulum sit
									amet tortor velit. Nam elementum nibh a
									libero pharetra elementum. Maecenas feugiat
									ex purus, quis volutpat lacus placerat
									malesuada.
								</p>
					...
					<div>
						<div class="box">
							<div class="image fit">
								<img src="images/hielo/pic03.jpg" alt="" />
							</div>
							<div class="content">
								<header class="align-center">
									<p>
		...
		<section id="two" class="wrapper style3">
			<div class="inner">
				<header class="align-center">
					<p>
						Nam vel ante sit amet libero scelerisque facilisis
						eleifend vitae urna
					</p>
			...
			<div class="inner">
				...
				<div class="gallery">
					<div>
						<div class="image fit">
							<a href="#"
								><img src="images/hielo/pic01.jpg" alt=""
							/></a>
						</div>
					</div>
					<div>
					...
					<div>
						<div class="image fit">
							<a href="#"
								><img src="images/hielo/pic04.jpg" alt=""
							/></a>
						</div>
					</div>
				</div>
...
.wrapper.style3 {
	background-color: #000;
	color: #bfbfbf;
	background-image: url(/images/hielo/bg.jpg);
...
<script>
var jquery = require("../../static/js/hielo/jquery.min.js");
var scrollex = require("../../static/js/hielo/jquery.scrollex.min.js");
export default {
	mounted() {
		let skelScript = document.createElement("script");
		skelScript.setAttribute("src", "/js/hielo/skel.min.js");
		document.head.appendChild(skelScript);

		let utilScript = document.createElement("script");
		utilScript.setAttribute("src", "/js/hielo/util.js");
		document.head.appendChild(utilScript);

		let mainHieloScript = document.createElement("script");
		mainHieloScript.setAttribute("src", "/js/hielo/main.js");
		document.head.appendChild(mainHieloScript);
	}
};
</script>